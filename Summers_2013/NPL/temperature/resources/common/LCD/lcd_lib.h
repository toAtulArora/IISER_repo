...
#define LCD_D4	5	//define MCU pin connected to LCD D3
#define LCD_D5	4	//define MCU pin connected to LCD D4
#define LCD_D6	3	//define MCU pin connected to LCD D5
#define LCD_D7	2	//define MCU pin connected to LCD D6
