...
//ACTUAL MEASUREMENT
	...
	ACSR = (1<<ACIC)|(0<<ACIS1)|(0<<ACBG);	//ACIS1 selects falling edge and internal band gap	//ACSR (analog comparator control & state register) 	//Always clear interrupt enable (ACIE) before changing this
