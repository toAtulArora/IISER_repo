...
\section{Objective}
	\cvline{\small{immediate}}{Get a PhD position to explore Quantum Theory.}
	\cvline{\small{general}}{Contribute to expanding our knowledge of nature.}

\section{Education}
	%\cventry{year--year}{Degree}{Institution}{City}{\textit{Grade}}{Description}
	\cventry{2016}{BS-MS Dual Degree}{Indian Institute of Science Education and Research}{Mohali}{CPI: \textit{9.4/10}}
	{
	...
	\textbf{Semester VIII}: (9.5/10) Nonlinear Dynamics, Chaos and Complex Systems, Condensed matter Physics Lab, Computational Methods in Physics, Standard Model and beyond, Selected topics in classical and quantum mechanics \\
        ...
        \textbf{Semester X}: (10/10): Cosmology and Galaxy Formation, MS Thesis - Research Project II
	}
...
\section{Experience (Academic)}	
        \cventry{2015-16}{Master's Thesis}{Indian Institute of Science Education and Research}{Mohali}{}{\emph{Contextuality in a Deterministic Quantum Theory.} The thesis research was carried out under the guidance of Prof. Arvind where we reconsidered the no-go theorems on hidden variables and concluded that the notion of contextuality is not a necessary feature of quantum mechanics. We provided an alternative view, motivated by consistency requirements between Bohmian Mechanics and the said theorems. This was accomplished by identifying a new classical property, we call `multiplicativity'. We proposed a non-contextual hidden variable model, consistent with all predictions of QM (for discrete spaces). Advantages of this view have been illuminated by discussion of implications of non-multiplicativity to non-locality and its relation to contextuality.}
...
\section{Publication (Academic)}
        ...
        \cvitem{2016}{A. S. A, Arvind. \emph{A non-contextual hidden variable model for quantum mechanics.} \href{http://arxiv.org/abs/1607.03498}{arXiv:1607.03498}}
        ...
        %\cvitem{2015-16}{A. S. A. \emph{Contextuality in a Deterministic Quantum Theory.} Thesis submitted for the masters degree}
\section{Teaching}
...
\section{Recognition}
	\cvline{2016}{Graduated with rank two in the Physics Department from IISER in 2016}
        \cvline{2016}{Top 5\% percent in the Graduate Aptitude Test in Engineering (GATE) for Physics}
        \cvline{2016}{Obtained a 92.3 percentile in the national graduate physics exam, Joint Entrance Screening Test (JEST)}
        \cvline{2015-16}{Amongst the highest scorers in both semesters of the academic session 2015-16}
        \cvline{2015}{Awarded the Junior Research Fellowship from the Council of Scientific and Industrial Research, India (JRF-NET)}
...
\section{Projects}
	...
	\cventry{Sem III\\2012}{Fly Count Assistant}{}{}{For easing the task of counting flies (Biology experiment), this application was written in Python and used extensively. With just two buttons on the keyboard, and the voice support, the counting process was made much more efficient}{}%
