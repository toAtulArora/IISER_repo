 \gamma(t) = C_C(*t,(*n-1)\alpha,*n\alpha)( \cos((*n-1)2\pi/*k)GX(*t-(*n-1)\alpha)) - \sin((*n-1)2\pi/*k)GY(*t-(*n-1)\alpha)
...
\gamma(t) = &(\lceil m(*t - ((0)\alpha)) \rceil)(\lfloor m(-*t + (1\alpha)) \rfloor + 1) \\
			&( \cos((0)2\pi/5)\\
			&((*t-(0)\alpha))\\
			&(1.2^{(*t-(0)\alpha)}))cos((*t-(0)\alpha))))\\ 
			&- \sin((0)2\pi/5)\\
