...
\section{Objective}
	\cvline{\small{short term}}{To get a PhD position to explore Quantum Physics.}
	\cvline{\small{general}}{To contribute to expanding our knowledge of nature.}
...
\section{Publication (Academic)}
        \cvitem{2015}{A. S. Arora, A. Asadian. \href{http://arxiv.org/abs/1508.04588}{``Towards a macroscopic test of local realism''}. In: \emph{arXiv}. Submitted to: \emph{Physical Review A}}.
\section{Projects}
...
\section{Recognition}
	\cvline{2015}{Awarded a Certificate of Merit for the best academic performance in the second semester of the academic session 2014-15}
        \cvline{2015}{Awarded the DAAD Wise fellowship for a summer internship in Germany}
