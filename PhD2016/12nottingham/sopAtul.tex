...
I haven't had any formal courses in QG but I am confident that I can pick up the bare essentials before joining the programme. Perhaps naively so, but I'm more inclined towards the loop quantum gravity (LQG) approach, as opposed to string theory. I have gleaned that the dynamics of LQG is the current active area of research with hamiltonian formulations and the spin foam alternative being among the studied approaches. I don't suppose I can formulate a research problem at the moment for my lack of knowledge about the area, however I hope that my past work supports my application to a PhD in this exciting field. The known applications to blackhole physics, could perhaps be a starting point. 

The University of Nottingham (UvN) has a vibrant group, consisting of various erudite researchers, such as the illustrious Prof. John Barrett, Prof. Kirill Krasnov, who is developing the spin foam formalism, and the eclectic Dr. Jorma Louko, who looks at quantum mechanical aspects of black holes and implications of acceleration in QFT, to quantum information, among other fundamental questions. With mavericks working in important and diverse fields, both within and outside QG, I believe, UvN will be an ideal place, for such a pursuit.
