...
\begin{center}
{\Large Statement of Purpose} \\[0.3in]
...
While I haven't had any formal courses in QG, I know that both popular approaches, Loop Quantum Gravity and String theory, are at the moment, not a complete description of nature, even though the latter is quite mature as a subject and has the more ambitious goal of unifying all forces. The theoretical physics department of Imperial College London (ICL) has two erudite groups of researchers investigating ``Quantum Gravity and Foundations of Quantum Mechanics'' and ``String Theory''. With mavericks like Prof. Fay Dowker, who has her own perspicacious take on the subject, the eclectic Prof. Jerome Gauntlett and the illustrious Prof. Michael Duff, exploiting diverse techniques to address the foundational problem of QG, I believe, ICL will be an ideal place to pursue my interests. While I can't formulate a precise research problem at the moment for my lack of knowledge about the area, I hope that my past work supports my application to a PhD in this exciting field. 

% I haven't had any formal courses in QG but I am confident I can pick up the bare essentials before joining the programme. I have gleaned that string theory is a promising framework for unification of all known forces, although it's still not mature enough. Consequently, both development of string theory itself and its applications to cosmology, for example, are of broad interest to me. Recently infact, even BM was applied to cosmology as a test to distinguish it from QM. While I am unable to formulate a precise research problem now, I hope that my past work supports my application to a PhD in this exciting field.
