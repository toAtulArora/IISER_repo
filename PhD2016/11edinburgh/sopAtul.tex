...
I have gleaned that string theory is a promising framework for unification of all known forces, although it's still not mature enough. Consequently, both development of string theory itself and its applications to particle physics \& cosmology, for example, are of broad interest to me. Recently infact, even BM was applied to cosmology as a test to distinguish it from QM. As I haven't had any formal courses in QG, I am unable to formulate a precise research problem now. I hope however, that my academic background and past work, support my application to a PhD in this exciting field.

The University of Edinburgh (UvE) has a vibrant group, consisting of various erudite researchers, such as the eclectic Dr. Joan Simon, who is interested in holography \& duality, cosmology and quantum information. With mavericks working in important and diverse fields, both within and outside QG, I believe, UvE will be an ideal place, for such a pursuit.

%University of Amsterdam (UvA) has a vibrant group, consisting of various erudite researchers, such as the illustrious string theorist, Prof. Erik Verlinde, who is also interested in black-holes and cosmology, and Dr. Ben Freivogel who specializes in cosmology, QFTs and string theory. With mavericks working in important and diverse fields, both within and outside QG, such as the eclectic Dr. Miranda Cheng, who is exploring the connection between string theory and mathematics, I believe, UvA will be an ideal place, for such a pursuit.
